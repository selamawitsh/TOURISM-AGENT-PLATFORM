  ...
  return (
    <div className="space-y-8">
      <section className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-8 shadow-2xl">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-3 text-slate-600">Monitor users, bookings, and insights with the full admin toolkit.</p>
          </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-[2rem] bg-gradient-to-br from-sky-500 to-sky-600 p-6 text-white shadow-lg">
          <div className="flex items-center justify-between">
            ...
            <div className="rounded-2xl bg-white/15 p-3">
              <svg className="h-10 w-10 text-sky-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="rounded-[2rem] bg-gradient-to-br from-emerald-500 to-emerald-600 p-6 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <div>
        ...
        <div className="rounded-[2rem] bg-gradient-to-br from-purple-500 to-purple-600 p-6 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <div>
        ...
        <div className="rounded-[2rem] bg-gradient-to-br from-orange-500 to-orange-600 p-6 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-orange-100">Active Tours</p>
              <p className="mt-3 text-3xl font-bold">42</p>
            </div>
            <div className="rounded-2xl bg-white/15 p-3">
              <svg className="h-10 w-10 text-orange-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-[2rem] bg-white p-6 shadow-lg">
          ...
          <Link to="/admin/users" className="text-sky-600 font-semibold hover:text-sky-700">Manage Users →</Link>
        </div>
        <div className="rounded-[2rem] bg-white p-6 shadow-lg">
          ...
          <Link to="/admin/analytics" className="text-sky-600 font-semibold hover:text-sky-700">View Analytics →</Link>
        </div>
      </div>
    </div>
  );
